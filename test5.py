...
def plot_frames(frames, titles, cmap='gray'):
    ...
    for i, frame in enumerate(frames):
        ...
        axs[i].axis('off')
    plt.show()
def process_video(input_directory, height, width, block_size, search_range, mv_output_file_prefix, residual_output_file_prefix, y_output_file_prefix):
    frame_counter = 0
...
process_video(input_directory, height, width, block_size, search_range, mv_output_file_prefix, residual_output_file_prefix, y_output_file_prefix)
