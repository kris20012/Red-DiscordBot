...
def process_video(input_directory, height, width, block_size, search_range, mv_output_file_prefix, residual_output_file_prefix, y_output_file_prefix, mae_output_file):
    frame_counter = 0
    mae_values = []
    ...
    # Save all average MAE values to a text file
...
process_video(input_directory, height, width, block_size, search_range, mv_output_file_prefix, residual_output_file_prefix, y_output_file_prefix, mae_output_file)
